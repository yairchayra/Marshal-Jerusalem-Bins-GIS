...
//ol.proj.get("EPSG:2039").setExtent([218119.927666, 632842.458225, 218645.716589, 633462.918285]);
var wms_layers = [];
...
var lyr__2 = new ol.layer.Vector({
                ...
                style: style__2,
                popuplayertitle: 'יעודי קרקע ירושלים',
                interactive: true,
    title: 'יעודי קרקע ירושלים<br />\
...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr__2.setVisible(false);lyr__3.setVisible(false);lyr__4.setVisible(false);lyr__5.setVisible(false);lyr__6.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_OpenStreetMap_1,lyr__2,group_,lyr__6];
lyr__2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'TABA': 'תכנית', 'MIGRASH': 'מגרש', 'YEUD': 'קוד יעוד', 'Descr': 'יעוד', 'Shape_STLe': 'Shape_STLe', 'Shape_STAr': 'Shape_STAr', });
...
lyr__2.set('fieldImages', {'OBJECTID': 'TextEdit', 'TABA': 'TextEdit', 'MIGRASH': 'TextEdit', 'YEUD': 'TextEdit', 'Descr': 'TextEdit', 'Shape_STLe': 'TextEdit', 'Shape_STAr': 'TextEdit', });
...
lyr__2.set('fieldLabels', {'OBJECTID': 'header label - visible with data', 'TABA': 'header label - visible with data', 'MIGRASH': 'header label - visible with data', 'YEUD': 'header label - visible with data', 'Descr': 'header label - visible with data', 'Shape_STLe': 'header label - visible with data', 'Shape_STAr': 'header label - visible with data', });
